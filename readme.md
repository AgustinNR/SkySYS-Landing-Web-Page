...
<html lang="en">
  <head>
    ...
    <title>
      SkySYS - Ingeniería en Sistemas de la Información
    </title>
    <link rel="icon" href="img/nube.png">
    <meta name="description" content="INGENIERÍA EN SISTEMAS DE LA INFORMACIÓN. Desarrollo de Sistemas de Gestión. Administrá tus recursos con sistemas profesionales diseñados a medida para tu negocio." />
    <meta name="keywords" content="sistemas, gestion, datos, ingenieria, software, negocio, empresa, compañia, analisis, a medida, informacion, IT, bases de datos" />
    <meta name="author" content="SkySYS" />
    ...
    <style>
      ...
      .gradient {
        background: linear-gradient(90deg, #3598FE 0%, #BBDBF2 110%);
      }
      .gradient2 {
        background: linear-gradient(90deg, #3598FE 0%, #BBDBF2 180%);
      }
      .parallax {
        /* background-image: url(img/header3.jpg); */
        background: linear-gradient(rgba(254, 254, 254, .9), rgba(254, 254, 254, .9)), url(img/header3.jpg);
        min-height: 500px;
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        <div class="pl-4 flex items-center">
          <a class="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            <img id="logoImage" class="" src="img/logo_claro.png" style="width: 30%; min-width: 64px; ">

          </a>
        </div>
        <div class="block lg:hidden pr-4">
          <button id="nav-toggle" class="flex items-center p-1 text-lightblue hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="#home">Inicio</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#aboutus">Nosotros</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#services">Servicios</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#portfolio">Proyectos</a>
            </li>
          </ul>
          <button
            id="navAction"
    ...
    <div id="home" class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full text-xl">
          ...
          <p class="leading-normal text-2xl mb-8">
            Administrá tus recursos con sistemas profesionales 
            <br /> 
            diseñados a medida para tu negocio.
          </p>
          <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onclick="window.location.href='#aboutus'">
            ¡Empecemos!
          </button>
        </div>
        <!--Right Col-->
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="img/Data%20extraction-amico.png" />
        </div>
      </div>
    </div>
    ...
    <section id="aboutus" class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              Construimos software y soluciones tecnológicas de alta calidad, para optimizar y potenciar procesos de negocios. Desarrollamos soluciones de datos ágiles y prácticas en plataformas de última tecnología, comprendiendo el contexto de las necesidades actuales y de las organizaciones, y la importancia de un buen manejo de la información.
            </p>
          </div>
          <div class="w-full sm:w-1/2 p-6">
            <img class="w-full md:w-4/5 z-50" src="img/Innovation-amico.png">
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <img class="w-full md:w-4/5 z-50" src="img/Creative team-amico.png">
              <path
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                SkySYS nace de la unión de profesionales con amplia experiencia y una calidad técnica y humana excepcional. Ponemos a disposición todas nuestras habilidades para lograr sistemas de información eficientes, agregando el más alto valor en cada implementación.
              </p>
              <button class="mx-auto lg:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" onclick="window.location.href='#services'">
                ¿Qué ofrecemos?
              </button>
            </div>
          </div>
    ...
    <section id="services" class="parallax border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800" >
          Nuestros Servicios
        </h2>
        <div class="w-full mb-4">
          <div class="h-1 mx-auto gradient w-64 opacity-35 my-0 py-0 rounded-t"></div>
        </div>
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              <div class="w-full text-gray-600 text-xs md:text-sm px-6 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" style="fill: rgba(53, 152, 254, 1);margin-top: 30px; margin-bottom: 5px;">
                  ...
                  <path d="M20.5 8H20v6.001c0 1.1-.893 1.993-1.99 1.999H8v.5c0 .827.673 1.5 1.5 1.5h7.167L22 22V9.5c0-.827-.673-1.5-1.5-1.5z"></path></svg>
              </div>
              <div class="w-full font-bold text-3xl text-center px-6 mb-50" style="color: #3598FE">
                Consultoría IT
              </div>
              <p class="text-gray-800 text-xl text-center px-6 mb-12">
                <br>Escuchamos tus necesidades, analizamos tu negocio y te proponemos un plan de acción especializado, logrando potenciar al máximo tus procesos mediante tecnologías de la información.
              </p>
            </a>
          </div>
<!--
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-xl text-center px-6 mb-12">
                <br>Desarrollamos sistemas de gestión acordes a cada necesidad y a tus preferencias: aplicaciones web, móviles y/o de escritorio.
                <br>Nuestras soluciones se ajustan a tu modelo de negocio con un alto nivel de detalle. 
              </p>
            </a>
          </div>
<!--
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              <div class="w-full text-gray-600 text-xs md:text-sm px-6 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" style="fill: rgba(53, 152, 254, 1);margin-top: 30px; margin-bottom: 5px;">
                  <path d="M4 21h17v-2H5V3H3v17a1 1 0 0 0 1 1z"></path><circle cx="10" cy="8" r="2"></circle><circle cx="18" cy="12" r="2"></circle><circle cx="11.5" cy="13.5" r="1.5"></circle><circle cx="16.5" cy="6.5" r="1.5"></circle></svg>
              </div>
              <div class="w-full font-bold text-3xl text-center px-6 mb-50" style="color: #3598FE">
                Big Data + AI Analytics
              </div>
              <p class="text-gray-800 text-xl text-center px-6 mb-12">
                <br>Implementamos sistemas de procesamiento y análisis de datos impulsados por inteligencia artifical. Observá fácilmente métricas para tomar decisiones basadas en datos, y fortalecer el crecimiento de tu negocio.
                <br>
              </p>
            </a>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-xl text-center px-6 mb-12">
                <br>Diseñamos aplicaciones para integar y gestionar eficientemente los procesos de tu negocio. Esto permite facilitar el control, disminuir errores y pérdidas, logrando aumentar la calidad de tu sistema e incrementar tus ganancias.
              </p>
            </a>
          </div>
<!--
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-xl text-center px-6 mb-12">
                <br>Creamos sistemas para que puedas gestionar las relaciones y las interacciones con tus clientes y proveedores de una manera sencilla y automatizada.
              </p>
            </a>
          </div>
<!--
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#contact" class="flex flex-wrap no-underline hover:no-underline">
              <div class="w-full text-gray-600 text-xs md:text-sm px-6 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 24 24" style="fill: rgba(53, 152, 254, 1);margin-top: 20px; margin-bottom: 5px;">
              ...
              <p class="text-gray-800 text-xl text-center px-6 mb-50">
                <br>Automatización industrial, robótica e Internet de las cosas. Te ayudamos a integrar las tecnologías de la Industria 4.0 a tu negocio y a optimizar aquellas que ya implementaste.
                <br>
              </p>
            </a>
          </div> <!--
    ...
    <section id="portfolio"class="building-sky">
  ...
  <section id="contact" class="bg-white py-8">
    <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
      ...
      <div class="w-full justify-center lg:w-full">
        <form class="w-auto bg-gray-100 p-8 rounded shadow-md" action="#" method="POST">
            <div class="mb-4">
                <input type="text" class="text-gray-500 w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-lightblue-500" placeholder="Nombre" required>
            </div>
            <div class="mb-4">
                <input type="email" class="text-gray-500 w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-lightblue-500" placeholder="Email" required>
            </div>
            <div class="mb-4">
                <input type="text" class="text-gray-500 w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-lightblue-500" placeholder="Teléfono">
            </div>
            <div class="mb-4">
                <textarea class="text-gray-500 w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-lightblue-500" placeholder="Hola! Estoy interesado en sus soluciones!" rows="4" required></textarea>
            </div>
            <div class="flex justify-center">
                <button type="submit" class="mx-auto w-3/5 justify-between m:mx-0 hover:underline gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Enviar</button>
            </div>
        </form>
      </div>
    </div>
  </section>
    <!-- Change the colour #fill="white" to match the previous section colour -->
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        ¡Consultá por nuestras soluciones digitales integrales!
      </h3>
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex-1 mb-6 text-black">
            <a class="text-lightblue no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
    ...
    <script>
      ...
      document.addEventListener("scroll", function () {
        ...
        if (scrollpos > 10) {
          ...
          navaction.classList.add("gradient2");
          ...
          logoImage.src = 'img/logo_oscuro.png';
        } else {
          header.classList.remove("bg-white");
          navaction.classList.remove("gradient2");
          ...
          logoImage.src = 'img/logo_claro.png';
        }
      });
    </script>
    <script>
